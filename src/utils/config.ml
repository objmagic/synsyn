...
let standard_library_default = "~/.opam/4.03.0+local-git-/lib/ocaml"
...
let standard_runtime = "~/.opam/4.03.0+local-git-/bin/ocamlrun"
let ccomp_type = "cc"
...
let host = "x86_64-apple-darwin15.4.0"
let target = "x86_64-apple-darwin15.4.0"
